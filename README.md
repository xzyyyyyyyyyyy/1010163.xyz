...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/1010163)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/1010163
```

A live public deployment of this template is available at [https://1010163.templates.workers.dev](https://1010163.templates.workers.dev)
